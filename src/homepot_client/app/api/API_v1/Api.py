...
from .Endpoints import HealthEndpoint, UIEndpoint, ClientEndpoint, SitesEndpoint, DevicesEndpoints, JobsEndpoints, AgentsEndpoints, UserRegisterEndpoint
...
api_v1_router.include_router(UserRegisterEndpoint.router, prefix="/auth", tags=["Authentication"])