...
# Generated by install.sh on Sat Aug 30 12:10:31 BST 2025

if [[ -f "test-path/bin/activate" ]]; then
    source "test-path/bin/activate"
    echo -e "\033[0;32mHOMEPOT Client environment activated\033[0m"
    echo "Virtual environment: test-path"
