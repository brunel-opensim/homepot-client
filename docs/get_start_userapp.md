...
> **Note:** The `user_app/android/` folder is auto-generated by Capacitor — you do not write or edit any Java or Gradle code manually. All app logic stays in the React/TypeScript source under `user_app/src/`. Capacitor simply wraps the built React app into a native Android shell.
